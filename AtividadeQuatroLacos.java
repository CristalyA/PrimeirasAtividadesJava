...
public class AtividadeQuatroLacos {
	...
	public static void main (String[] args) {
		...
		while(pessoas<=2) {
			...
			while(idade<1 || idade>120) {
				System.out.println("\nQual a sua idade novamente ? ");
				idade = leia.nextInt();
			}			
				System.out.println("\nQual o genero ?\n(1)Feminino\n(2)Masculino\n(3)Não declarado");
				genero = leia.nextInt();
			while(genero<1 || genero>3) {
				System.out.println("\nQual o genero novamente ?\n(1)Feminino\n(2)Masculino\n(3)Não declarado");
				genero = leia.nextInt();		
			}
			System.out.println("\nQual seu principal fator psicológico:\n(1)Calma\n(2)Nervosa\n(3)Agressiva");
			fp = leia.nextInt();
			while (fp<1 || fp>3) {
				System.out.println("\nQual seu fator psicológico novamente ? \n(1)Calma\n(2)Nervosa\n(3)Agressiva");
				fp=leia.nextInt();
			}
			if (fp == 1) {
				contPc++;
			...
			System.out.println("\nQuantidade de pessoas não declaradas calmas: "+contNdc);
